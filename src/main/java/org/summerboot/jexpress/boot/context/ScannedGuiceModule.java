...
public class ScannedGuiceModule extends AbstractModule {
    ...
    protected final static String INFO_FOUND = BootConstants.BR + "\t- Ioc.scan.found: ";
    protected final static String INFO_BIND = BootConstants.BR + "\t- Ioc.override.binding: ";
    ...
    public void configure() {
            ...
            for (String uniqueKey : taggedServiceMap.keySet()) {
                ...
                if (notNamed) {//non-named: one(interface) <--> one(Impl)
                    ...
                    if (isCliUseImplTag) {
                        ...
                        namedServiceImpls.put(named, serviceImpl);//override default, favor -use <implTag> over default
                    }
                    /*//favor -use <implTag> over default
        ...
        try {
            ...
            memo.append(BootConstants.BR).append("\t- Ioc.userdefined.ChannelHandlers: ").append(c);
