...
abstract public class SummerBigBang extends SummerSingularity {
    ...
    protected SummerBigBang(Class callerClass, Module userOverrideModule, String... args) {
        ...
        bigBang(super.primaryClass, args);
    }
    ...
    private void bigBang(Class primaryClass, String... args) {
        letThereBeCLI(args);
        if (runCLI_Utils()) {
            System.exit(0);
        }
        runCLI_GetApplicationConfig(primaryClass);
         ...
         */
        theGenesis(primaryClass, userSpecifiedImplTags);//trigger subclass to init IoC container
    }
    ...
    protected void letThereBeCLI(String[] args) {
        ...
        List<SummerInitializer> summerCLIs = scanImplementation_SummerInitializer();
        for (SummerInitializer summerCLI : summerCLIs) {
    ...
    protected void runCLI_GetApplicationConfig(Class primaryClass) {
        /*
         * [IoC] - set user selected implementations to override the default
         * should be invoked before theGenesis was initialezed to avoid caller invoks LogManager.static{}
         */
     ...
     */
    protected void theGenesis(Class primaryClass, Set<String> userSpecifiedImplTags) {
