...
public interface BootErrorCode {
    ...
    int HTTP_REQUEST_TIMEOUT = getErrorCode(IO_BASE + 2);// a ioc is not received within a specified time period.
    ...
    int RTO_PWD_NOT_MATCH = getErrorCode(RTO_CLS_EXIT + 18);
}
