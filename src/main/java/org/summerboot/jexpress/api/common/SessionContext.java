...
//        }
    ...
    public SessionContext reportOverall(long queuingTime, long processTime, long responseTime, StringBuilder sb) {
        ...
        sb.append(protocol).append(" ").append(requestMethod).append(" ").append(httpRequestUriRawDecoded).append(" ").append(status)
                .append(" [error=").append(errorCount).append(", queuing=").append(queuingTime).append("ms, process=").append(processTime).append("ms, response=").append(responseTime).append("ms]")
                .append(" [").append(txId).append(" ").append(localIP).append("]")
                .append(" caller=").append(remoteIP).append("=").append(caller == null ? callerId : caller);
        return this;
    }
