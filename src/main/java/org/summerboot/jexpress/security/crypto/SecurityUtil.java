 ...
 *
 */
package org.summerboot.jexpress.security.crypto;
...
public class SecurityUtil {
    ...
    public static String promptPassword(String prompt, String confirmPrompt) {
        ...
        while (true) {
            ...
            String password = new String(firstPass);
    ...
    public static String generateOneTimeToken() {
        return generateOneTimeToken("t_", 32, 64);
    }

    public static String generateOneTimeToken(String prefix, int minLen, int maxLen) {
        if (minLen < 1) {
