...
class JaxRsRequestParameter {
    ...
    public enum ParamType {
        Request, Response, Body_STRING, Body_JSON, Body_XML, Body_OnDemand_ByClientRequestType, PathParam, MatrixParam, QueryParam, FormParam, HeaderParam, CookieParam
    }
...
//                if (requestBodyAllowed) {
                if (targetClass.equals(String.class)) {
                    ...
                    if (consumes == null) {//default
                        type = ParamType.Body_OnDemand_ByClientRequestType;
                    } else {
...
//                }
    ...
    public Object value(ServiceRequest request, SessionContext context) /*throws JAXBException*/ {
        ...
        if (currentType.equals(ParamType.Body_OnDemand_ByClientRequestType)) {
        ...
        switch (currentType) {
            ...
            case Body_XML:
                ...
                return postDataObj;
            case Body_OnDemand_ByClientRequestType:
                v = request.getHttpPostRequestBody();
