...
public class LdapSslConnectionFactory5 extends SocketFactory {
    ...
    public LdapSslConnectionFactory5() {
        try {
    ...
    public static SocketFactory getDefault() {
        final LdapSslConnectionFactory5 value = defaultFactory.get();
        if (value == null) {
            defaultFactory.compareAndSet(null, new LdapSslConnectionFactory5());
