 ...
 *
 */
package org.summerboot.jexpress.integration.ldap.ssl;
 ...
 */
public class LdapSslConnectionFactory1 extends SocketFactory {

    protected static final AtomicReference<LdapSslConnectionFactory1> defaultFactory = new AtomicReference<>();
    ...
    public LdapSslConnectionFactory1() {
        try {
    ...
    public static SocketFactory getDefault() {
        final LdapSslConnectionFactory1 value = defaultFactory.get();
        if (value == null) {
            defaultFactory.compareAndSet(null, new LdapSslConnectionFactory1());
