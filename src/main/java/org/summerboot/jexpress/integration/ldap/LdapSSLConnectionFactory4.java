 ...
 */
public class LdapSSLConnectionFactory4 extends SocketFactory {

    private static final AtomicReference<LdapSSLConnectionFactory4> defaultFactory = new AtomicReference<>();
    ...
    public static SocketFactory getDefault() {
        final LdapSSLConnectionFactory4 value = defaultFactory.get();
        if (value == null) {
