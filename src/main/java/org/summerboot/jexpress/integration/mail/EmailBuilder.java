 ...
 *
 */
package org.summerboot.jexpress.integration.mail;
...
public class EmailBuilder {
    ...
    public static class EmailAttachment implements Serializable {
        ...
        /**
         * @param type       - the file extension, ie. "pdf", image
         * @param dataStream
         * @param fileName
         * @param cid
         */
    ...
    public MimeMessage buildMimeMessage(Session emailSession) throws MessagingException {
        ...
        if (StringUtils.isBlank(email.getFrom())) {
            email.setFrom(emailSession.getProperty(SmtpClientConfig.KEY_USER_DISPLAYNAME), emailSession.getProperty("mail.mail.user"));
        }
