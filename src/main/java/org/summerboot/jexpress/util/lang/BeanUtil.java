 ...
 *
 */
package org.summerboot.jexpress.util.lang;
...
public class BeanUtil {
    ...
    protected static final FilterProvider ServiceErrorFilter = new SimpleFilterProvider()
            .addFilter(BootConstants.JSONFILTER_NAME_SERVICEERROR, SimpleBeanPropertyFilter.serializeAllExcept("ref"));
    protected static final FilterProvider EmptyFilter = new SimpleFilterProvider()
            .addFilter(BootConstants.JSONFILTER_NAME_SERVICEERROR, SimpleBeanPropertyFilter.serializeAll());
