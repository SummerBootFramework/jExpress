...
public interface RequestProcessor {
    ...
    void process(ChannelHandlerContext ctx, HttpHeaders httpRequestHeaders, String httpRequestPath, Map<String, List<String>> queryParams, String httpPostRequestBody, ServiceContext context, int errorcodeRequestValidationFailed) throws Throwable;
